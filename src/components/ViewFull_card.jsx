  ...
  return (
    <div>
      <div className='flex items-baseline gap-52 h-30 w-full p-5 bg-blue-950'>
        <h1 className='flex items-baseline'><IndianRupee className='text-white' /><h1 className='font-bold text-3xl text-white'>{props.total_price}</h1> <small className='text-sm font-medium text-gray-300'>@{props.price_sqft} per sqft</small></h1>
      ...
      <div className='flex min-h-screen bg-blue-50'>
        ...
        <div className='flex flex-col gap-10 ml-10 mt-10  bg-white/30 backdrop-blur-md shadow-md hover:shaow-lg rounded-3xl h-100 w-180 p-5 border-t-4 border-gray-700 mr-2 '>
          <div>
            ...
            <h1 className='font-medium text-gray-500'>Starting price:{props.total_price}++</h1>
          </div>
